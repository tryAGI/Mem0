...
namespace Mem0
{
    public partial class MemoriesClient
    {
        ...
        private static readonly global::Mem0.EndPointSecurityRequirement s_MemoriesEntityReadSecurityRequirement0 =
        ...
        private static readonly global::Mem0.EndPointSecurityRequirement[] s_MemoriesEntityReadSecurityRequirements =
            new global::Mem0.EndPointSecurityRequirement[]
            {                s_MemoriesEntityReadSecurityRequirement0,
            };
        ...
        partial void ProcessMemoriesEntityReadResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var __authorizations = global::Mem0.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_MemoriesEntityReadSecurityRequirements,
                operationName: "MemoriesEntityReadAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareMemoriesEntityReadRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessMemoriesEntityReadResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Mem0.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if ((int)__response.StatusCode == 400)
                            {
                                ...
                                global::Mem0.MemoriesEntityReadResponse2? __value_400 = null;
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        __content_400 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                        __value_400 = global::Mem0.MemoriesEntityReadResponse2.FromJson(__content_400, JsonSerializerContext);
                                    }
                                    else
                                    {
                                        __content_400 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                ...
                                throw global::Mem0.ApiException<global::Mem0.MemoriesEntityReadResponse2>.Create(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessMemoriesEntityReadResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Mem0.MemoriesEntityReadResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Mem0.AutoSDKHttpResponse<global::Mem0.MemoriesEntityReadResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Mem0.MemoriesEntityReadResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
