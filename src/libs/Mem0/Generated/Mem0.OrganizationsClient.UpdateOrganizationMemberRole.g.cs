...
namespace Mem0
{
    public partial class OrganizationsClient
    {
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Mem0.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Mem0.AutoSDKHttpResponse<global::Mem0.UpdateOrganizationMemberRoleResponse>> UpdateOrganizationMemberRoleAsResponseAsync(
            string orgId,
                ...
                else
                {
                    await global::Mem0.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if ((int)__response.StatusCode == 400)
                            {
                                ...
                                throw global::Mem0.ApiException<global::Mem0.UpdateOrganizationMemberRoleResponse2>.Create(
                            ...
                            if ((int)__response.StatusCode == 404)
                            {
                                ...
                                throw global::Mem0.ApiException<global::Mem0.UpdateOrganizationMemberRoleResponse3>.Create(
                                    statusCode: __response.StatusCode,
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Mem0.UpdateOrganizationMemberRoleResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Mem0.AutoSDKHttpResponse<global::Mem0.UpdateOrganizationMemberRoleResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Mem0.UpdateOrganizationMemberRoleResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
