...
namespace Mem0
{
    ...
    public sealed class AutoSDKConditionalResponse<T>
    {
        internal AutoSDKConditionalResponse(
            bool notModified,
            string? entityTag,
            global::Mem0.AutoSDKHttpResponse<T>? response)
        {
        ...
        public global::Mem0.AutoSDKHttpResponse<T>? Response { get; }
    }
    ...
    public static class AutoSDKConditionalRequests
    {
        ...
        /// </summary>
        public static async global::System.Threading.Tasks.Task<global::Mem0.AutoSDKConditionalResponse<T>> SendAsync<T>(
            global::System.Func<global::Mem0.AutoSDKRequestOptions, global::System.Threading.CancellationToken, global::System.Threading.Tasks.Task<global::Mem0.AutoSDKHttpResponse<T>>> send,
            string? entityTag = null,
            global::Mem0.AutoSDKRequestOptions? requestOptions = null,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return new global::Mem0.AutoSDKConditionalResponse<T>(
                    notModified: false,
                    entityTag: GetEntityTag(response.Headers),
                    response: response);
            }
            catch (global::Mem0.ApiException exception)
        ...
        private static global::Mem0.AutoSDKRequestOptions CloneRequestOptions(
            global::Mem0.AutoSDKRequestOptions? source)
        {
            var clone = new global::Mem0.AutoSDKRequestOptions();
            if (source == null)
            {
                return clone;
            }
