...
namespace Mem0
{
    public partial class ProfilesClient
    {
        ...
        private static readonly global::Mem0.EndPointSecurityRequirement s_ProfilesSettingsUpdateSecurityRequirement0 =
        ...
        private static readonly global::Mem0.EndPointSecurityRequirement[] s_ProfilesSettingsUpdateSecurityRequirements =
            new global::Mem0.EndPointSecurityRequirement[]
            {                s_ProfilesSettingsUpdateSecurityRequirement0,
            };
        partial void PrepareProfilesSettingsUpdateArguments(
            global::System.Net.Http.HttpClient httpClient,
            global::Mem0.ProfilesSettingsUpdateRequest request);
        partial void PrepareProfilesSettingsUpdateRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::Mem0.ProfilesSettingsUpdateRequest request);
        partial void ProcessProfilesSettingsUpdateResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessProfilesSettingsUpdateResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Mem0.ProfilesSettingsUpdateResponse> ProfilesSettingsUpdateAsync(

            global::Mem0.ProfilesSettingsUpdateRequest request,
            global::Mem0.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await ProfilesSettingsUpdateAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Mem0.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Mem0.AutoSDKHttpResponse<global::Mem0.ProfilesSettingsUpdateResponse>> ProfilesSettingsUpdateAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareProfilesSettingsUpdateArguments(
            ...
            var __authorizations = global::Mem0.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_ProfilesSettingsUpdateSecurityRequirements,
                operationName: "ProfilesSettingsUpdateAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareProfilesSettingsUpdateRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Mem0.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Mem0.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "ProfilesSettingsUpdate",
                                methodName: "ProfilesSettingsUpdateAsync",
                                pathTemplate: "\"/v2/profiles/settings/\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessProfilesSettingsUpdateResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Mem0.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessProfilesSettingsUpdateResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Mem0.ProfilesSettingsUpdateResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Mem0.AutoSDKHttpResponse<global::Mem0.ProfilesSettingsUpdateResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Mem0.ProfilesSettingsUpdateResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::Mem0.ProfilesSettingsUpdateResponse> ProfilesSettingsUpdateAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Mem0.ProfilesSettingsUpdateRequest
            {
                Enabled = enabled,
                Entities = entities,
            };

            return await ProfilesSettingsUpdateAsync(
                request: __request,
                requestOptions: requestOptions,
