...
namespace Mem0
{
    public partial class DreamClient
    {
        ...
        private static readonly global::Mem0.EndPointSecurityRequirement s_UpdateDreamConfigSecurityRequirement0 =
        ...
        private static readonly global::Mem0.EndPointSecurityRequirement[] s_UpdateDreamConfigSecurityRequirements =
            new global::Mem0.EndPointSecurityRequirement[]
            {                s_UpdateDreamConfigSecurityRequirement0,
            };
        partial void PrepareUpdateDreamConfigArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string orgId,
            ref string projectId,
            global::Mem0.UpdateDreamConfigRequest request);
        partial void PrepareUpdateDreamConfigRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string orgId,
            string projectId,
            global::Mem0.UpdateDreamConfigRequest request);
        partial void ProcessUpdateDreamConfigResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessUpdateDreamConfigResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Mem0.UpdateDreamConfigResponse> UpdateDreamConfigAsync(
            string orgId,
            string projectId,
        ...
        {
            var __response = await UpdateDreamConfigAsResponseAsync(
                orgId: orgId,
                projectId: projectId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Mem0.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Mem0.AutoSDKHttpResponse<global::Mem0.UpdateDreamConfigResponse>> UpdateDreamConfigAsResponseAsync(
            string orgId,
            string projectId,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareUpdateDreamConfigArguments(
            ...
            var __authorizations = global::Mem0.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_UpdateDreamConfigSecurityRequirements,
                operationName: "UpdateDreamConfigAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::Mem0.PathBuilder(
                                path: $"/api/v1/orgs/organizations/{orgId}/projects/{projectId}/dream/config/",
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareUpdateDreamConfigRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Mem0.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Mem0.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "UpdateDreamConfig",
                                methodName: "UpdateDreamConfigAsync",
                                pathTemplate: "$\"/api/v1/orgs/organizations/{orgId}/projects/{projectId}/dream/config/\"",
                                httpMethod: "PATCH",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessUpdateDreamConfigResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Mem0.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessUpdateDreamConfigResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Mem0.UpdateDreamConfigResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Mem0.AutoSDKHttpResponse<global::Mem0.UpdateDreamConfigResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Mem0.UpdateDreamConfigResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::Mem0.UpdateDreamConfigResponse> UpdateDreamConfigAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Mem0.UpdateDreamConfigRequest
            {
                ReflectionEnabled = reflectionEnabled,
                ReflectionMode = reflectionMode,
            };

            return await UpdateDreamConfigAsync(
                orgId: orgId,
                projectId: projectId,
                request: __request,
                requestOptions: requestOptions,
