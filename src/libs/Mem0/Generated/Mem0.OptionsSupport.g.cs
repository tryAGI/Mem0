...
namespace Mem0
{
    ...
    public sealed class AutoSDKClientOptions
    {
        ...
        /// </summary>
        public global::Mem0.AutoSDKRetryOptions Retry { get; set; } = new global::Mem0.AutoSDKRetryOptions();
        ...
        /// </summary>
        public global::System.Collections.Generic.List<global::Mem0.IAutoSDKHook> Hooks { get; } =
            new global::System.Collections.Generic.List<global::Mem0.IAutoSDKHook>();
        ...
        public global::Mem0.AutoSDKClientOptions AddHook(
            global::Mem0.IAutoSDKHook hook)
        {
        ...
        /// </summary>
        public global::Mem0.IAutoSDKAuthorizationProvider? AuthorizationProvider { get; set; }
        ...
        public global::Mem0.AutoSDKClientOptions UseAuthorizationProvider(
            global::Mem0.IAutoSDKAuthorizationProvider provider)
        {
            AuthorizationProvider = provider ?? throw new global::System.ArgumentNullException(nameof(provider));
            if (Hooks.Find(static x => x is global::Mem0.AutoSDKAuthorizationProviderHook) == null)
            {
                Hooks.Add(new global::Mem0.AutoSDKAuthorizationProviderHook());
            }
    ...
    public readonly struct AutoSDKAuthorizationValue
    {
        ...
        public static global::Mem0.AutoSDKAuthorizationValue Bearer(string token) => new(value: token, scheme: "Bearer");

        /// <summary>Convenience factory for an API-key header.</summary>
        public static global::Mem0.AutoSDKAuthorizationValue ApiKeyHeader(string name, string value) =>
    ...
    public interface IAutoSDKAuthorizationProvider
    {
        ...
        global::System.Threading.Tasks.Task<global::System.Collections.Generic.IReadOnlyList<global::Mem0.AutoSDKAuthorizationValue>?> ResolveAsync(
            global::Mem0.AutoSDKHookContext context);
    }
...
#pragma warning restore CS0618
    ...
    /// </summary>
    public sealed class AutoSDKAuthorizationProviderHook : global::Mem0.AutoSDKHook
    {
        /// <inheritdoc />
            ...
            global::Mem0.AutoSDKHookContext context)
        {
            ...
            if (perRequest != null && perRequest.Count > 0)
            {
                ...
                global::Mem0.AutoSDKHttpRequestOptions.StampAuthorizationOverride(context.Request);
                return;
            }
        ...
        private static void ApplyAuthorization(
            global::System.Net.Http.HttpRequestMessage request,
            global::Mem0.AutoSDKAuthorizationValue authorization)
        {
    ...
    public sealed class AutoSDKRequestOptions
    {
        ...
        /// </summary>
        public global::Mem0.AutoSDKRetryOptions? Retry { get; set; }
        ...
        /// </summary>
        public global::System.Collections.Generic.IReadOnlyList<global::Mem0.AutoSDKAuthorizationValue>? Authorizations { get; set; }
    }
    ...
    /// </summary>
    public abstract class AutoSDKHook : global::Mem0.IAutoSDKHook
    {
        /// <inheritdoc />
    ...
    public sealed class AutoSDKHookContext
    {
        ...
        /// </summary>
        public global::Mem0.AutoSDKClientOptions ClientOptions { get; set; } = null!;

        /// <summary>
        /// The per-request runtime options.
        /// </summary>
        public global::Mem0.AutoSDKRequestOptions? RequestOptions { get; set; }
    ...
    {
        internal static global::Mem0.AutoSDKHookContext CreateHookContext(
            string operationId,
            string methodName,
            string pathTemplate,
            string httpMethod,
            ...
            global::Mem0.AutoSDKClientOptions clientOptions,
            global::Mem0.AutoSDKRequestOptions? requestOptions,
            int attempt,
            int maxAttempts,
            bool willRetry,
        ...
        {
            return new global::Mem0.AutoSDKHookContext
            {
        ...
        internal static global::System.TimeSpan GetRetryDelay(
            ...
            int attempt)
        {
            var retryOptions = requestOptions?.Retry ?? clientOptions.Retry ?? new global::Mem0.AutoSDKRetryOptions();
        ...
        private static global::System.TimeSpan ClampRetryDelay(
            global::System.TimeSpan delay,
            global::Mem0.AutoSDKRetryOptions retryOptions)
        {
        ...
        private static async global::System.Threading.Tasks.Task InvokeHooksAsync(
            global::Mem0.AutoSDKClientOptions clientOptions,
            global::System.Func<global::Mem0.IAutoSDKHook, global::Mem0.AutoSDKHookContext, global::System.Threading.Tasks.Task> callback,
            global::Mem0.AutoSDKHookContext context)
        {
