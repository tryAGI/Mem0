...
namespace Mem0
{
    public partial class UsersClient
    {
        ...
        private static readonly global::Mem0.EndPointSecurityRequirement s_UsersCreateSecurityRequirement0 =
        ...
        private static readonly global::Mem0.EndPointSecurityRequirement[] s_UsersCreateSecurityRequirements =
            new global::Mem0.EndPointSecurityRequirement[]
            {                s_UsersCreateSecurityRequirement0,
            };
        partial void PrepareUsersCreateArguments(
            global::System.Net.Http.HttpClient httpClient,
            global::Mem0.CreateUser request);
        partial void PrepareUsersCreateRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::Mem0.CreateUser request);
        partial void ProcessUsersCreateResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessUsersCreateResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var __authorizations = global::Mem0.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_UsersCreateSecurityRequirements,
                operationName: "UsersCreateAsync");
                ...
                else
                {
                    await global::Mem0.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessUsersCreateResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    return
                                        global::Mem0.CreateUser.FromJson(__content, JsonSerializerContext) ??
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    return
                                        await global::Mem0.CreateUser.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
