...
namespace Mem0
{
    public partial class DreamClient
    {
        ...
        private static readonly global::Mem0.EndPointSecurityRequirement s_GetDreamRunsSecurityRequirement0 =
        ...
        private static readonly global::Mem0.EndPointSecurityRequirement[] s_GetDreamRunsSecurityRequirements =
            new global::Mem0.EndPointSecurityRequirement[]
            {                s_GetDreamRunsSecurityRequirement0,
            };
        partial void PrepareGetDreamRunsArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string orgId,
            ref string projectId,
            ref int? limit,
            ref string? cursor);
        partial void PrepareGetDreamRunsRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            int? limit,
            string? cursor);
        partial void ProcessGetDreamRunsResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGetDreamRunsResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Mem0.GetDreamRunsResponse> GetDreamRunsAsync(
            string orgId,
            string projectId,
            int? limit = default,
        ...
        {
            var __response = await GetDreamRunsAsResponseAsync(
                orgId: orgId,
                projectId: projectId,
                limit: limit,
                cursor: cursor,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Mem0.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Mem0.AutoSDKHttpResponse<global::Mem0.GetDreamRunsResponse>> GetDreamRunsAsResponseAsync(
            string orgId,
            string projectId,
            int? limit = default,
            string? cursor = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var __authorizations = global::Mem0.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_GetDreamRunsSecurityRequirements,
                operationName: "GetDreamRunsAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::Mem0.PathBuilder(
                                path: $"/api/v1/orgs/organizations/{orgId}/projects/{projectId}/dream/runs/",
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Mem0.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Mem0.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "GetDreamRuns",
                                methodName: "GetDreamRunsAsync",
                                pathTemplate: "$\"/api/v1/orgs/organizations/{orgId}/projects/{projectId}/dream/runs/\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                else
                {
                    await global::Mem0.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGetDreamRunsResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Mem0.GetDreamRunsResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Mem0.AutoSDKHttpResponse<global::Mem0.GetDreamRunsResponse>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Mem0.GetDreamRunsResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
